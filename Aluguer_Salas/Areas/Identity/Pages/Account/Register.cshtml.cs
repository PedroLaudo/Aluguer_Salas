    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Atribui o Nome vindo do formulário
            ...
            // Se algo falhou, mostra novamente o formulário
            return Page();
        }
        ...
        private Utilizadores CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Não foi possível criar uma instância de '{nameof(Utilizadores)}'. " +
                    $"Assegura-te que '{nameof(Utilizadores)}' não é abstrata e tem um construtor sem parâmetros.");
            }
        }
